...
//            Vehicle[] allVehicles = {hatchback, suv, sedan, truck, crossover};
            Car testing = new Car(2010, "Subaru", 20100, 2000, "hatchback", "Outback", "SE", "Silver");
            Plane newPlane = new Plane(2010, "homies", 21, 12312, 747);

            System.out.println("inherited branch" + testing.brand);
            testing.accelerate();
            testing.accelerate();
            testing.accelerate();
            System.out.println("current speed" + testing.speed);
            testing.slowDown();
            System.out.println("slowed down speed" + testing.speed);

            newPlane.accelerate();
            newPlane.accelerate();
            newPlane.slowDown();
            System.out.println("plane speed  " + newPlane.speed);
